    ...
    case "SignUp":
      cardContent = (
        <form className={styles.inputContainer}>
          ...
          <div className={styles.inputs}>
            <Inputs cardType="mandatory" text="Enter First Name" />
            <Inputs cardType="mandatory" text="Enter Last Name" />
            <Inputs cardType="mandatory" text="Enter Email Address" />
            <Inputs text="Enter Company Name" />
            <Inputs cardType="mandatory" text="Enter Country/Region" />
            <div className={styles.byContinuingYouContainer}>
              ...
              {`, `}
              <span className={styles.cookiePreferences}>
                Cookie Preferences
              </span>
              .
            </div>
          ...
          <div className={styles.buttonsWrapper}>
            <Buttons cardType="submit" text="Continue" state={true} />
          </div>
            ...
            <div className={styles.weSentAContainer}>
              <span className={styles.weSentAContainer1}>
                <p className={styles.weSentA}>
                  {`We sent a temporary login code to ` + mail + `.`}
                </p>
                <p className={styles.notYou}>Not you?</p>
              </span>
            </div>
            <Inputs text="Enter Login Code" />
            <div className={styles.byContinuingYouContainer}>
              By continuing, you agree to Nilcloud's
              <span className={styles.termsOfService}>Terms of Service</span>
              {`, `}
    ...
    case "Password":
      cardContent = (
        <form className={styles.inputContainer}>
          ...
          <div className={styles.inputs}>
            <Inputs cardType="mandatory" text="Create New Password" />
            <Inputs cardType="mandatory" text="Confirm New Password" />
            <div className={styles.passwordRequirementsMustContainer}>
              <p className={styles.passwordRequirements1}>
